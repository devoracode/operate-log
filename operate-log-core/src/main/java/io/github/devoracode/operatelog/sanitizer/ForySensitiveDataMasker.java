...
/**
 * 基于 Fory JSON 动态树（{@code JsonObject} / {@code JsonArray}）的敏感数据脱敏器：
 ...
 */
public class ForySensitiveDataMasker implements SensitiveDataMasker {
    ...
    public ForySensitiveDataMasker(Set<String> sensitiveFields, String maskText) {
        this(ForyJsons.defaultJson(), sensitiveFields, maskText);
    }

    public ForySensitiveDataMasker(ForyJson json, Set<String> sensitiveFields, String maskText) {
        this.json = json;
